    ...
    if (onUpdateGroup && (initialGroup || (editTask && taskFormData.isGroupTask))) {
      ...
      const updatedTasks = subtasks.map((st, index) => {
        ...
        return {
          ...
          pressId: taskFormData.press,
          press: selectedPress?.name || '',
          lastMaintenance: (taskFormData.lastMaintenance?.getTime() !== initialValues.lastMaintenance?.getTime()) ? taskFormData.lastMaintenance : (initialTask?.lastMaintenance || taskFormData.lastMaintenance),
          nextMaintenance: (taskFormData.nextMaintenance?.getTime() !== initialValues.nextMaintenance?.getTime()) ? taskFormData.nextMaintenance : (initialTask?.nextMaintenance || taskFormData.nextMaintenance),
